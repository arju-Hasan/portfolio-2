...
export default function Footer() {
  ...
  return (
    <footer className="footer-surface relative w-full overflow-hidden border-t pb-10 pt-12 transition-colors duration-300">
      ...
      <div className="absolute left-10 top-10 hidden h-4 w-4 rotate-45 border border-[color:var(--foreground)] opacity-25 md:block" />
      <div className="absolute bottom-40 right-10 hidden h-3 w-3 rounded-full bg-[color:var(--foreground)] opacity-20 md:block" />
      ...
      <div className="container relative z-10 mx-auto flex flex-col items-center justify-center px-6 text-center">
        <h2 className="mb-2 text-4xl font-bold tracking-tight md:text-6xl">
          <span className="footer-muted">Let&apos;s</span>{" "}
        ...
        <p className="footer-muted mx-auto mb-5 max-w-md text-sm leading-relaxed md:text-base">
        ...
        <div className="flex gap-4">
          <a
            className="footer-chip flex h-10 w-10 items-center justify-center rounded-full transition-colors hover:border-blue-500/50 hover:bg-blue-500/10 hover:text-blue-500"
      ...
      <aside className="footer-muted mt-6 text-center text-sm">
        <p>
      ...
      <p className="footer-muted mt-3 text-center text-xs">
