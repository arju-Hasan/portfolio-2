...
export default function Footer() {
  ...
  return (
    <footer className="relative w-full overflow-hidden border-t border-gray-200 bg-gradient-to-b from-neutral-100 to-neutral-50 pb-10 pt-12 text-neutral-800 dark:border-gray-800 dark:from-gray-950 dark:via-black/85 dark:to-black dark:text-gray-300">
      ...
      <div className="container relative z-10 mx-auto flex flex-col items-center justify-center px-6 text-center">
        <h2 className="mb-2 text-4xl font-bold tracking-tight md:text-6xl">
          <span className="text-neutral-500 dark:text-gray-400">Let&apos;s</span>{" "}
      ...
      <p className="text-sm text-neutral-500 dark:text-gray-500 text-center">Built with TypeScript, React, Next.js, Tailwind CSS, and EmailJS</p>    
      </footer>
  );
}
